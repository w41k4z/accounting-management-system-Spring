...
<head>
    ...
    <link rel="stylesheet" href="/static/assets/css/landingPage.css">
    <title>Welcome</title>
</head>
<body>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            <a href="." class="navbar-brand">
                <img src="/static/images/e-society.png" alt="" width="67px" height="67px">
            </a>
    ...
    <!-- Header Start -->
    <div class="mt-auto jumbotron jumbotron-fluid position-relative overlay-bottom">
        <div class="container text-center py-5">
            <h1 class="text-white display-2 mb-5 mt-5">Manage your company From Home</h1>
    ...
    <script src="/static/assets/css/lib/bootstrap/js/bootstrap.min.js"></script>
</body>
</html>